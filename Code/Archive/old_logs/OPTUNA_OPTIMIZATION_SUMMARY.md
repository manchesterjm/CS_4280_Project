...
> **⚠️ HISTORICAL DOCUMENT**: This summary is from November 9, 2025 describing early Optuna work on the 655-window dataset.
>
> **Final Results (December 6, 2025)**:
> - **AUC: 0.9261** (vs 0.7154 baseline described below)
> - **100% Recall** on TESS Sector 1 test set (6,579 windows)
> - Total improvement: +33.3% over baseline
