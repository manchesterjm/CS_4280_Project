...
> **⚠️ DEPRECATED**: This guide is from October 2025 and describes troubleshooting for the original 655-window dataset.
> **For current usage, see:** `../README.md` and `../NEXT_SESSION_QUICKSTART.md`
>
> **Final Results (December 6, 2025)**: AUC 0.9261, 100% Recall on TESS Sector 1 dataset (33,051 windows)
