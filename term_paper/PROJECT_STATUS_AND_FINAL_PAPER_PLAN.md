...
#### Research Paper Materials (`term_paper/materials/`)
...
- **Main file**: `term_paper/COMPLETE_OVERLEAF_PASTE.tex`
...
- **Status**: Downloaded to term_paper/paper_sources/
...
**Presentation Files**:
- Create: `term_paper/FINAL_PRESENTATION.pptx` or LaTeX Beamer slides
- Include: All visualizations from `Code/reports/` and `term_paper/materials/figures/`
...
### Paper Materials
- `term_paper/COMPLETE_OVERLEAF_PASTE.tex` - Main LaTeX file (copy to Overleaf)
- `term_paper/resourceFile.bib` - Bibliography (6 papers, need 3 more)
- `term_paper/materials/` - Methodology, tables, figures, scripts
- `term_paper/documentation/` - Project documentation
